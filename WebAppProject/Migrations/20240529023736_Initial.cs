        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Creator_id = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_registerMealInfos_AspNetUsers_User_Id",
                        column: x => x.User_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_basicMeals_Creator_id",
                table: "basicMeals",
                column: "Creator_id");

            migrationBuilder.CreateIndex(
                name: "IX_mainMeals_Creator_id",
                table: "mainMeals",
                column: "Creator_id");

            migrationBuilder.CreateIndex(
                name: "IX_registerMealInfos_User_Id",
                table: "registerMealInfos",
                column: "User_Id");

            migrationBuilder.CreateIndex(
                name: "IX_sideMeals_Creator_id",
                table: "sideMeals",
                column: "Creator_id");
        }
